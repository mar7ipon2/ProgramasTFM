...
El objetivo principal de este proyecto es ofrecer una implementación rigurosa y didáctica de los conceptos fundamentales de la teoría de lenguajes formales y construir paramétricamente un analizador léxico y sintáctico para la lógica proposicional utilizando el lenguaje de programación funcional **Haskell**.
