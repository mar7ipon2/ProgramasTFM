# Formalización de Lenguajes Formales en Haskell
...
El objetivo principal de este proyecto es ofrecer una implementación rigurosa y didáctica de los conceptos fundamentales de la teoría de lenguajes formales utilizando el lenguaje de programación funcional **Haskell**. 
Una vez establecida la base teórica, se ofrece una aplicación directa, descrita en el documento **"AnálisisLéxicoSintácticoLogProposicional"** de los conceptos en forma de un analizador léxico y sintáctico para la lógica proposicional.
